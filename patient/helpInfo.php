...
<footer>
    <div class="footer">
        ...
        <div class="glyphicon glyphicon-arrow-right" style="float:right" id="arrows" onclick="window.location.href='helpFinancial.php'"></div>
        <p style="float:right; font-size: 2rem; color: black">Continue to Financial Help  </p>
